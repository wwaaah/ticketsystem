...
async def on_interaction(interaction: discord.Interaction):
    if interaction.type == discord.InteractionType.component:
        ...
        if interaction.data["custom_id"] == "support":
            ...
            await channel.send(f"{interaction.user.mention} 🎫 Support Ticket has been created! An admin will assist you shortly.")
            ...
            channel = await guild.create_text_channel(channel_name, category=category, overwrites=overwrites)
            await channel.send(f"{interaction.user.mention} 🛒 Purchase Ticket has been created! Please describe what you’d like to buy.")
